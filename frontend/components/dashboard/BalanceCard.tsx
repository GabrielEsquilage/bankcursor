...
export function BalanceCard({
  ...
  return (
    <div className="bg-[#050505] rounded-lg p-8 border border-white/30 relative overflow-hidden">
      <div className="flex flex-col gap-12">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right space-y-1">
            ...
            <p className="text-xs font-mono text-white/60 tracking-tighter">
              {accountNumber}
            </p>
          </div>
        </div>
      ...
      <div className="absolute top-0 right-0 w-16 h-16 bg-white/2 rotate-45 translate-x-8 -translate-y-8 border border-b border-white/5" />
    </div>
  );
}
